...
void predecessor(int data[], int target) {
    ...
    for (int i = 0; i + 1 < inList.size(); i++) {
        if (inList[i + 1] == target) {
            cout << inList[i] << " ";
            break;
        }
    }
    for (int i = 0; i + 1 < preList.size(); i++) {
        if (preList[i + 1] == target) {
            cout << preList[i] << " ";
            break;
        }
    }
    for (int i = 0; i + 1 < postList.size(); i++) {
